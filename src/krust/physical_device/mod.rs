...
//limits: VkPhysicalDeviceLimits{
	...
	pub viewport_dounds_range: [f32; 2], // viewportBoundsRange: [0.0f32; 2],
...
impl PhysicalDevice {
	...
	pub fn create(handle: VkPhysicalDevice) -> Self {
		...
		let mut properties = VkPhysicalDeviceProperties{
				...
				deviceName: [b'\0' as libc::c_uchar; VK_MAX_PHYSICAL_DEVICE_NAME_SIZE],
				pipelineCacheUUID: [0u8; VK_UUID_SIZE],
				limits: VkPhysicalDeviceLimits{
					maxImageDimension1D: 0u32,
					maxImageDimension2D: 0u32,
					maxImageDimension3D: 0u32,
					maxImageDimensionCube: 0u32,
					maxImageArrayLayers: 0u32,
					maxTexelBufferElements: 0u32,
					maxUniformBufferRange: 0u32,
					maxStorageBufferRange: 0u32,
					maxPushConstantsSize: 0u32,
					maxMemoryAllocationCount: 0u32,
					maxSamplerAllocationCount: 0u32,
					bufferImageGranularity: 0 as VkDeviceSize,
					sparseAddressSpaceSize: 0 as VkDeviceSize,
					maxBoundDescriptorSets: 0u32,
					maxPerStageDescriptorSamplers: 0u32,
					maxPerStageDescriptorUniformBuffers: 0u32,
					maxPerStageDescriptorStorageBuffers: 0u32,
					maxPerStageDescriptorSampledImages: 0u32,
					maxPerStageDescriptorStorageImages: 0u32,
					maxPerStageDescriptorInputAttachments: 0u32,
					maxPerStageResources: 0u32,
					maxDescriptorSetSamplers: 0u32,
					maxDescriptorSetUniformBuffers: 0u32,
					maxDescriptorSetUniformBuffersDynamic: 0u32,
					maxDescriptorSetStorageBuffers: 0u32,
					maxDescriptorSetStorageBuffersDynamic: 0u32,
					maxDescriptorSetSampledImages: 0u32,
					maxDescriptorSetStorageImages: 0u32,
					maxDescriptorSetInputAttachments: 0u32,
					maxVertexInputAttributes: 0u32,
					maxVertexInputBindings: 0u32,
					maxVertexInputAttributeOffset: 0u32,
					maxVertexInputBindingStride: 0u32,
					maxVertexOutputComponents: 0u32,
					maxTessellationGenerationLevel: 0u32,
					maxTessellationPatchSize: 0u32,
					maxTessellationControlPerVertexInputComponents: 0u32,
					maxTessellationControlPerVertexOutputComponents: 0u32,
					maxTessellationControlPerPatchOutputComponents: 0u32,
					maxTessellationControlTotalOutputComponents: 0u32,
					maxTessellationEvaluationInputComponents: 0u32,
					maxTessellationEvaluationOutputComponents: 0u32,
					maxGeometryShaderInvocations: 0u32,
					maxGeometryInputComponents: 0u32,
					maxGeometryOutputComponents: 0u32,
					maxGeometryOutputVertices: 0u32,
					maxGeometryTotalOutputComponents: 0u32,
					maxFragmentInputComponents: 0u32,
					maxFragmentOutputAttachments: 0u32,
					maxFragmentDualSrcAttachments: 0u32,
					maxFragmentCombinedOutputResources: 0u32,
					maxComputeSharedMemorySize: 0u32,
					maxComputeWorkGroupCount: [0u32; 3],
					maxComputeWorkGroupInvocations: 0u32,
					maxComputeWorkGroupSize: [0u32; 3],
					subPixelPrecisionBits: 0u32,
					subTexelPrecisionBits: 0u32,
					mipmapPrecisionBits: 0u32,
					maxDrawIndexedIndexValue: 0u32,
					maxDrawIndirectCount: 0u32,
					maxSamplerLodBias: 0.0f32,
					maxSamplerAnisotropy: 0.0f32,
					maxViewports: 0u32,
					maxViewportDimensions: [0u32; 2],
					viewportBoundsRange: [0.0f32; 2],
					viewportSubPixelBits: 0u32,
					minMemoryMapAlignment: 0 as usize,
					minTexelBufferOffsetAlignment: 0 as VkDeviceSize,
					minUniformBufferOffsetAlignment: 0 as VkDeviceSize,
					minStorageBufferOffsetAlignment: 0 as VkDeviceSize,
					minTexelOffset: 0i32,
					maxTexelOffset: 0u32,
					minTexelGatherOffset: 0i32,
					maxTexelGatherOffset: 0u32,
					minInterpolationOffset: 0.0f32,
					maxInterpolationOffset: 0.0f32,
					subPixelInterpolationOffsetBits: 0u32,
					maxFramebufferWidth: 0u32,
					maxFramebufferHeight: 0u32,
					maxFramebufferLayers: 0u32,
					framebufferColorSampleCounts: 0 as VkSampleCountFlags,
					framebufferDepthSampleCounts: 0 as VkSampleCountFlags,
					framebufferStencilSampleCounts: 0 as VkSampleCountFlags,
					framebufferNoAttachmentsSampleCounts: 0 as VkSampleCountFlags,
					maxColorAttachments: 0u32,
					sampledImageColorSampleCounts: 0 as VkSampleCountFlags,
					sampledImageIntegerSampleCounts: 0 as VkSampleCountFlags,
					sampledImageDepthSampleCounts: 0 as VkSampleCountFlags,
					sampledImageStencilSampleCounts: 0 as VkSampleCountFlags,
					storageImageSampleCounts: 0 as VkSampleCountFlags,
					maxSampleMaskWords: 0u32,
					timestampComputeAndGraphics: false as VkBool32,
					timestampPeriod: 0.0f32,
					maxClipDistances: 0u32,
					maxCullDistances: 0u32,
					maxCombinedClipAndCullDistances: 0u32,
					discreteQueuePriorities: 0u32,
					pointSizeRange: [0.0f32; 2],
					lineWidthRange: [0.0f32; 2],
					pointSizeGranularity: 0.0f32,
					lineWidthGranularity: 0.0f32,
					strictLines: false as VkBool32,
					standardSampleLocations: false as VkBool32,
					optimalBufferCopyOffsetAlignment: 0 as VkDeviceSize,
					optimalBufferCopyRowPitchAlignment: 0 as VkDeviceSize,
					nonCoherentAtomSize: 0 as VkDeviceSize,
					},
				sparseProperties: VkPhysicalDeviceSparseProperties{
					residencyStandard2DBlockShape: false as VkBool32,
					residencyStandard2DMultisampleBlockShape: false as VkBool32,
					residencyStandard3DBlockShape: false as VkBool32,
					residencyAlignedMipSize: false as VkBool32,
					residencyNonResidentStrict: false as VkBool32,
				},
				};
	...
	//limits: VkPhysicalDeviceLimits{
			...
			viewport_dounds_range: properties.limits.viewportBoundsRange,
